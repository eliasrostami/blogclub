...
class $AssetsImgIconsGen {
  ...
  /// File path: assets/img/icons/butterfly.png
  AssetGenImage get butterfly =>
      const AssetGenImage('assets/img/icons/butterfly.png');
  ...
  /// File path: assets/img/icons/ic_papiloo.svg
  SvgGenImage get icPapiloo =>
      const SvgGenImage('assets/img/icons/ic_papiloo.svg');
  ...
  /// File path: assets/img/icons/youtube.svg
  SvgGenImage get youtube => const SvgGenImage('assets/img/icons/youtube.svg');
}
